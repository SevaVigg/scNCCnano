# This is the entry point to the nanostring data analysis
# tested with R version, Seurat version Slingshot version 1.0.0
#
#The main process of treatment NCC nanostring data; execute all other scripts and makes all plots
#
# Finished by Vsevolod J. Makeev 15.06.2021, developed 2017 - 2021 
