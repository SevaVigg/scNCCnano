...
cellColors <- cut( featureValues/max(featureValues), breaks= seq(0, 1, 0.1))
...
plot( plotVals[,2]~ plotVals[,1], cex = 0.7, pch = 16, col = as.character(cellColors), xlab = paste0(dimRed, "_1"), ylab = paste0(dimRed, "_2"))
